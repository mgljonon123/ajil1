...
export default function CameraProductPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-white p-8">
      <h1 className="text-4xl font-bold mb-4 text-gray-900">Camera Product</h1>
      <p className="text-lg text-gray-700 mb-8">
        Detailed information about our Camera Product will appear here.
      </p>
      ...
      <div className="w-full max-w-xl bg-gray-50 rounded-lg p-6 shadow text-center">
        ...
        <p className="text-gray-700">
          Information about <b>{subOptions[subTab]}</b> for the Camera Product
          will be shown here.
        </p>
      </div>
    </main>
