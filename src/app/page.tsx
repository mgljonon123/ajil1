...
export default function Home() {
  ...
  const comments = [
    ...
    },
    {
      ...
      comment:
        "The surveillance network has significantly improved our security.",
      rating: 5,
    },
    {
      id: 5,
      ...
      company: "SecureTech",
      comment: "Top-notch biometric access control system.",
      rating: 5,
    },
    {
      id: 6,
      ...
      comment: "Cost-effective solution with excellent features.",
      rating: 4,
    },
    {
      id: 7,
      ...
      role: "CEO",
      company: "StartupXYZ",
      comment: "Perfect for our growing business needs.",
      rating: 5,
    },
    {
      id: 8,
      ...
      comment: "Reliable and user-friendly interface.",
      rating: 4,
    },
    {
      id: 9,
      ...
      comment: "Great for campus security management.",
      rating: 5,
    },
    {
      id: 10,
      ...
      comment: "Meets all our security compliance requirements.",
      rating: 5,
    },
    {
      id: 11,
      ...
      comment: "Excellent integration with existing systems.",
      rating: 4,
    },
    {
      id: 12,
      ...
      comment: "Advanced features with simple operation.",
      rating: 5,
    },
  ];
    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-white py-16 px-4">
      <section className="w-full max-w-3xl text-center mb-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
          ...
          <div
            className="w-64 h-40 bg-black flex items-center justify-center rounded-lg shadow-md cursor-pointer hover:ring-4 hover:ring-blue-400 transition"
            onClick={() => router.push("/products/camera")}
            tabIndex={0}
            role="button"
            aria-label="View Camera Product"
          >
          ...
          <div
            className="w-64 h-40 bg-black flex items-center justify-center rounded-lg shadow-md cursor-pointer hover:ring-4 hover:ring-blue-400 transition"
            onClick={() => router.push("/products/alarm")}
            tabIndex={0}
            role="button"
            aria-label="View Alarm Chip"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Complete home automation and security solution with AI-powered
              threat detection.
            </p>
          ...
          <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900">
              Commercial Surveillance Network
            </h3>
            <p className="text-gray-600 mb-4">
              Enterprise-grade surveillance system for large commercial
              properties.
            </p>
            <div className="flex gap-2 justify-center">
          ...
          <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 mb-4">
              Biometric and RFID-based access control for high-security
              facilities.
            </p>
            <div className="flex gap-2 justify-center">
      ...
      <section className="w-full max-w-6xl text-center mb-12">
        ...
        >
          {comments.map((comment) => (
            <div
              key={comment.id}
              className="bg-gray-50 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow min-w-[400px] flex-shrink-0"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Leading provider of advanced security solutions for homes and
                businesses. We specialize in AI-powered surveillance, access
                control systems, and comprehensive security management.
              </p>
